...
[^1]: The plural suffix is usually /j/-, but due to the restriction \*/jj/, /j/ dissimilates to /h/.

# Root and word minimality

Roots are minimally disyllabic and maximally trisyllabic.
Words are minimally disyllabic but can have more than three syllables when affixes are added.
...
Exeptions: some inalienable objects (like head, eyes) are monosyllabic, but posessive prefixes are mandatory and thus make them disyllabic. For example:

- */jh/ 'eye' > /t-jh/ 'my eye' \[n̩.ˈja\], plural /t-jh-j/ 'my eyes' \[n̩.ˈʃi\].

## Phonotactic restrictions

Roots have the following phonotactic restrictions:

- No more than two consecutive identical phonemes are allowed.
- Sonority cannot decrease in the first two phonemes of the root (the sonority hierarchy is /s,r, j, h/ > /t/): */htj/, */jtr/, but /hrt/, /jst/.
